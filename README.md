...
Role: Data Engineer (Streaming / Orchestration / Monitoring)

- Built and optimized data pipelines in Databricks using PySpark to process and transform IoT sensor data across Bronze.
